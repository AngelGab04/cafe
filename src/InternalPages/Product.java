...
DefaultTableModel model;
    ...
    public Product() {
      ...
      public void filter(String qry ){
             model = (DefaultTableModel) prod_tbl.getModel();
         TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(model);
         prod_tbl.setRowSorter(trs);
    ...
    private void initComponents() {
        ...
        FILT = new javax.swing.JComboBox<>();
        ...
        BG_pnl.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 790, 300));
        ...
        FILT.setBackground(new java.awt.Color(204, 202, 240));
        FILT.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ALL", "DRINKS", "CAKE", "COFFEE" }));
        FILT.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                FILTItemStateChanged(evt);
            }
        });
        BG_pnl.add(FILT, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 130, 240, 40));
    ...
    private void edit_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_btnMouseClicked
        ...
        if(rowIndex < 0){
           ...
           prod.prodimg_display.setIcon(prod.ResizeImage(rs.getString("product_image"), null,prod.prodimg_display));
                prod.oldpath = rs.getString("product_image");   
            prod.setVisible(true);
            prod.action = "Update";
    ...
    private void FILTItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_FILTItemStateChanged
          String qry = FILT.getSelectedItem().toString();
     
        filter(qry);
    }//GEN-LAST:event_FILTItemStateChanged


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel BG_pnl;
    private javax.swing.JComboBox<String> FILT;
